...
model = CrossViT(image_size=512, channels=3, num_classes=1, patch_size_small=16, patch_size_large=32).to(device)
print(model)
summary(model, input_size=(3, 512, 512))  # [B, num_classes]
